...
#create_clock -period 4.760 -name dco [get_ports dco_p]
...
#set_input_delay -clock dco -max 2.38 [get_ports da_p];
#set_input_delay -clock dco -min 2.18 [get_ports da_p];
#set_input_delay -clock dco -max 2.38 [get_ports da_p] -clock_fall -add_delay;
#set_input_delay -clock dco -min 2.18 [get_ports da_p] -clock_fall -add_delay;
#
#set_input_delay -clock dco -max 2.38 [get_ports db_p];
#set_input_delay -clock dco -min 2.18 [get_ports db_p];
#set_input_delay -clock dco -max 2.38 [get_ports db_p] -clock_fall -add_delay;
#set_input_delay -clock dco -min 2.18 [get_ports db_p] -clock_fall -add_delay;

set_property IDELAY_VALUE 28 [get_cells i_system_wrapper/system_i/axi_ltc2387/inst/i_if/i_rx_db/i_rx_data_idelay]
set_property IDELAY_VALUE 28 [get_cells i_system_wrapper/system_i/axi_ltc2387/inst/i_if/i_rx_da/i_rx_data_idelay]
