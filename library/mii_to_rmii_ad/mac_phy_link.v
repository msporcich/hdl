...
module mac_phy_link
  ...
  always @(posedge ref_clk) begin
      if (!reset_n) begin
          ...
          if (mii_tx_clk_10_100_r == 1'b0) begin
              num_r <= 0;
  ...
  assign rising_tx_clk_w = rising_tx_clk_r1;
